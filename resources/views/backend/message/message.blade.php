<div id="messages">
    <a id="messagesDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
        ...
        <a href="{{ route('message.index') }}" class="dropdown-item text-center text-gray-500">
            Xem tất cả tin nhắn
        </a>
    </div>
</div>
        ...
        $(document).ready(function() {
            ...
            Echo.channel('message')
                .listen('MessageSent', (e) => {
                    ...
                    const data = `<a class="dropdown-item d-flex align-items-center message-item" href="${e.message.url}">
                                    <div class="dropdown-list-image mr-3">
