...
@section('main-content')
    <div class="card shadow">
        <div class="card-header shadow">
            <h5 class="text-primary text-uppercase font-weight-bold">Sửa banner</h5>
        </div>
            ...
            <form action="{{ route('banner.update', $banner->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value="active" {{ $banner->status == 'active' ? 'selected' : '' }}>Có hiệu lực</option>
                        <option value="inactive" {{ $banner->status == 'inactive' ? 'selected' : '' }}>Vô hiệu lực</option>
                    </select>
