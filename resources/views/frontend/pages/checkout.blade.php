...
@section('main-content')
    ...
    <section class="shop checkout section">
        <div class="container">
            <form action="{{ route('cart.order') }}" method="post" class="form">
                @csrf
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_name" required value="{{ old('lat_name') }}"
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address1" required value="{{ old('address1') }}"
                                            placeholder="Nhập địa chỉ giao hàng (bắt buộc) ...">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address2" value="{{ old('address2') }}"
                                            placeholder="Nhập địa chỉ thứ 2 (nếu có) ...">
                                ...
                                <div class="content">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">
                                            Tổng
                                            <span>{{ number_format(Helper::totalCartPrice(), 2) }} VND</span>
                                        </li>
                                        <li class="shipping">
                                            Phí giao hàng
                                            @if (count(Helper::shipping()) > 0 && Helper::cartCount() > 0)
                                                <select name="shipping" class="nice-select">
                                                    <option value="">--Chọn kiểu giao hàng--</option>
                                                    @foreach (Helper::shipping() as $shipping)
                                                        <option value="{{ $shipping->id }}" class="shippingOption"
                                                            data-price="{{ $shipping->price }}">{{ $shipping->type }}:
                                                            {{ $shipping->price }} VND</option>
                                                    @endforeach
                                                </select>
                                            @else
                                                <span>Miễn phí</span>
                                        ...
                                        @if (session('coupon'))
                                            <li class="coupon_price" data-price="{{ session('coupon')['value'] }}">
                                                Tiết kiệm
                                                <span>{{ number_format(session('coupon')['value'], 2) }} VND</span>
                                            </li>
                                        @endif
                                        @php
                                        ...
                                        @if (session('coupon'))
                                            <li class="last" id="order_total_price">
                                                Tổng cộng
                                                <span>{{ number_format($total_amount, 2) }} VND</span>
                                            </li>
                                        @else
                                            <li class="last" id="order_total_price">
                                                Tổng cộng
                                ...
                                <div class="content">
                                    <div class="checkbox">
                                        <form-group>
                                            ...
                                            <label for="cod">Nhận hàng thanh toán</label>
                                            <br>
                                            <input id="banking" name="payment_method" type="radio" value="banking">
